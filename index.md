...
helper: ["Erwin Lares", "Siyuan Feng", "Mary Roth", "Chris Endemann", "Sarah Stevens", "Mary Murphy", "Christina Koch", "Jamene Brooks-Kieffer"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p id="when">
  <strong>When:</strong>
  {{page.humantime}} on the following dates: {{page.humandate}}.
